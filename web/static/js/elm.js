...
var _user$project$Data$foodCollection = {
	ctor: '::',
	_0: {name: '煮鸡蛋', protein: 0.121, fat: 0.105, carbohydrate: 2.1e-2, note: '51g/个', defaultQuantity: 51},
	_1: {
		ctor: '::',
		_0: {name: '蛋白', protein: 0.116, fat: 1.0e-3, carbohydrate: 3.1e-2, note: '31g/个', defaultQuantity: 31},
		_1: {
			ctor: '::',
			_0: {name: '烤鸡胸', protein: 0.182, fat: 4.7e-2, carbohydrate: 2.4e-2, note: '', defaultQuantity: 100},
			_1: {
				ctor: '::',
				_0: {name: '牛肉', protein: 0.162, fat: 2.8e-2, carbohydrate: 2.3e-2, note: '', defaultQuantity: 100},
				_1: {
					ctor: '::',
					_0: {name: '米饭', protein: 2.6e-2, fat: 3.0e-3, carbohydrate: 0.762, note: '', defaultQuantity: 135},
					_1: {ctor: '[]'}
				}
			}
		}
...
var _user$project$Data$FoodInfo = F6(
	function (a, b, c, d, e, f) {
		return {name: a, protein: b, fat: c, carbohydrate: d, note: e, defaultQuantity: f};
	});

var _user$project$Messages$AddFood = F2(
	function (a, b) {
		return {ctor: 'AddFood', _0: a, _1: b};
	});
...
var _user$project$Messages$SelectNutritionTab = function (a) {
	return {ctor: 'SelectNutritionTab', _0: a};
};
var _user$project$Messages$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};
var _user$project$Messages$Submit = {ctor: 'Submit'};
var _user$project$Messages$TrainingTime = function (a) {
	return {ctor: 'TrainingTime', _0: a};
};
var _user$project$Messages$WeightFatRate = function (a) {
	return {ctor: 'WeightFatRate', _0: a};
};
var _user$project$Messages$Weight = function (a) {
...
var _user$project$Helpers$cellStyle = {
	ctor: '::',
...
var _user$project$Helpers$itemCell = function (styling) {
	return _debois$elm_mdl$Material_Grid$cell(
		_elm_lang$core$List$concat(
			{
				ctor: '::',
				_0: _user$project$Helpers$cellStyle,
				_1: {
					ctor: '::',
					_0: styling,
					_1: {ctor: '[]'}
...
var _user$project$Helpers$bigCell = _user$project$Helpers$itemCell(
	{
		ctor: '::',
...
var _user$project$Helpers$smallCell = _user$project$Helpers$itemCell(
	{
		ctor: '::',
...
var _user$project$Helpers$white = _debois$elm_mdl$Material_Color$text(_debois$elm_mdl$Material_Color$white);
var _user$project$Helpers$rowStyle = {
	ctor: '::',
...
var _user$project$Helpers$titleStyle = {
	ctor: '::',
	_0: A2(_debois$elm_mdl$Material_Options$css, 'display', 'flex'),
	_1: {
		ctor: '::',
		...
		_1: {
			ctor: '::',
			_0: A2(_debois$elm_mdl$Material_Options$css, 'justify-content', 'space-around'),
			_1: {ctor: '[]'}
		}
	}
};
var _user$project$Helpers$defaultHeaderWithNavigation = F2(
	function (headerText, navigation) {
		return {
			ctor: '::',
			_0: A2(
				_debois$elm_mdl$Material_Layout$row,
				_user$project$Helpers$rowStyle,
				{
					ctor: '::',
					_0: A2(
						_debois$elm_mdl$Material_Layout$title,
						_user$project$Helpers$titleStyle,
						{
							ctor: '::',
...
var _user$project$Helpers$defaultHeader = function (headerText) {
	return {
		ctor: '::',
		_0: A2(
			_debois$elm_mdl$Material_Layout$row,
	...
	function (src_url, route) {
		...
		switch (_p0.ctor) {
			...
			case 'InfoCollectionRoute':
				return A2(_elm_lang$core$Basics_ops['++'], src_url, '/infocollection');
			case 'FoodRoute':
				return A2(_elm_lang$core$Basics_ops['++'], src_url, '/food');
			case 'IntroRoute':
				return A2(_elm_lang$core$Basics_ops['++'], src_url, '/intro');
			default:
				return src_url;
		}
	});
...
var _user$project$Routing$routingItem = function (src_url) {
	return {
		ctor: '::',
		_0: {ctor: '_Tuple4', _0: '计算结果', _1: 'apps', _2: _user$project$Routing$HomeRoute, _3: src_url},
		_1: {
			ctor: '::',
			_0: {
				ctor: '_Tuple4',
				_0: '数据输入',
				_1: 'list',
				_2: _user$project$Routing$InfoCollectionRoute,
				_3: A2(_elm_lang$core$Basics_ops['++'], src_url, '/infocollection')
			},
			_1: {
				ctor: '::',
				_0: {
					...
					_0: '健康饮食',
					_1: 'dashboard',
					_2: _user$project$Routing$FoodRoute,
					_3: A2(_elm_lang$core$Basics_ops['++'], src_url, '/food')
				},
				_1: {
					ctor: '::',
					_0: {
						...
						_0: '产品简介',
						_1: 'dashboard',
						_2: _user$project$Routing$IntroRoute,
						_3: A2(_elm_lang$core$Basics_ops['++'], src_url, '/intro')
					},
					_1: {ctor: '[]'}
				}
			}
						...
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return {mdl: a, selectedMenuTab: b, selectedNutritionTab: c, route: d, url: e, inputValues: f, fundamental: g, metabolism: h, highDayNutrition: i, lowDayNutrition: j, selectedFoods: k};
										};
									};
								};
							};
...
var _user$project$Views_Food$foodList = A2(
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('食物'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
...
var _user$project$Views_Food$selectedFoodList = function (selectedFood) {
	return A2(
		_debois$elm_mdl$Material_Table$table,
		{
			ctor: '::',
							...
							_1: {
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('删除'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _user$project$Helpers$white,
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
							...
							},
							{
								...
								_0: A2(
									_debois$elm_mdl$Material_Options$span,
									{
										...
										_1: {
											ctor: '::',
											_0: _debois$elm_mdl$Material_Typography$contrast(0.87),
											_1: {ctor: '[]'}
										}
									},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text(
											_elm_lang$core$Basics$toString(foodInfo.defaultQuantity)),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
										...
										model.mdl,
										{
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: _debois$elm_mdl$Material_Options$onClick(
														A2(_user$project$Messages$AddFood, foodInfo.name, foodInfo.defaultQuantity)),
													_1: {ctor: '[]'}
												}
											}
										},
...
var _user$project$Views_Food$foodAsCards = function (model) {
	return A2(
		...
		A2(
			_elm_lang$core$List$map,
			function (elem) {
				return _user$project$Helpers$smallCell(
					{
						ctor: '::',
...
var _user$project$Views$inputLabel = F3(
	function (defaultMesssage, append, inputNum) {
		var _p0 = inputNum;
		if (_p0.ctor === 'Just') {
			return _elm_lang$core$Native_Utils.eq(_p0._0, _user$project$Config$invalidValue) ? '请输入有效数字' : '';
		} else {
			return defaultMesssage;
		}
	});
var _user$project$Views$valueValidation = F3(
	function (maybeNum, minValue, maxValue) {
		var _p1 = maybeNum;
		if (_p1.ctor === 'Just') {
			return _elm_lang$core$Native_Utils.eq(_p1._0, _user$project$Config$invalidValue);
		} else {
			return false;
		}
	});
							...
							_0: A5(
								...
								model.mdl,
								{
									...
									_0: _debois$elm_mdl$Material_Textfield$label(
										A3(_user$project$Views$inputLabel, '请输入体重(公斤): 例如 75', '公斤', model.inputValues.weight)),
									_1: {
										ctor: '::',
										...
										_1: {
											...
											_1: {
												...
												_1: {
													...
													_0: A2(
														_debois$elm_mdl$Material_Options$when,
														A3(_user$project$Views$valueValidation, model.inputValues.weight, 3, 200),
														_debois$elm_mdl$Material_Textfield$error('请输入有效数字: 例如 75')),
													_1: {ctor: '[]'}
												}
											}
										}
							...
							{ctor: '[]'},
							{
								...
								_0: A5(
									...
									model.mdl,
									{
										ctor: '::',
										_0: _debois$elm_mdl$Material_Textfield$label(
											A3(_user$project$Views$inputLabel, '请输入体脂率: 例如 0.23', ' :体脂率', model.inputValues.weight_fat_rate)),
										_1: {
											ctor: '::',
											...
											_1: {
												...
												_1: {
													...
													_1: {
														...
														_0: A2(
															_debois$elm_mdl$Material_Options$when,
															A3(_user$project$Views$valueValidation, model.inputValues.weight_fat_rate, 0.1, 0.7),
															_debois$elm_mdl$Material_Textfield$error('请输入有效数字: 例如 0.23')),
														_1: {ctor: '[]'}
													}
												}
											}
								...
								{ctor: '[]'},
								{
									...
									_0: A5(
										...
										model.mdl,
										{
											ctor: '::',
											_0: _debois$elm_mdl$Material_Textfield$label(
												A3(_user$project$Views$inputLabel, '请输入训练时长: 例如 90', ' 分钟训练时间', model.inputValues.training_time)),
											_1: {
												ctor: '::',
												...
												_1: {
													...
													_1: {
														...
														_1: {
															...
															_0: A2(
																_debois$elm_mdl$Material_Options$when,
																A3(_user$project$Views$valueValidation, model.inputValues.training_time, 1, 1440),
																_debois$elm_mdl$Material_Textfield$error('请输入有效数字: 例如 90')),
															_1: {ctor: '[]'}
														}
													}
												}
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('营养元素'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('数量'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
							...
							return A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text(item.material),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
...
var _user$project$Views$nutritionView = function (model) {
	return A6(
		...
		model.mdl,
		{
			...
			_1: {
				ctor: '::',
				_0: _debois$elm_mdl$Material_Tabs$onSelectTab(_user$project$Messages$SelectNutritionTab),
				_1: {
					ctor: '::',
					_0: _debois$elm_mdl$Material_Tabs$activeTab(model.selectedNutritionTab),
					_1: {ctor: '[]'}
				}
			}
		},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _debois$elm_mdl$Material_Icon$i('code'),
						_1: {
							ctor: '::',
							_0: A2(
								_debois$elm_mdl$Material_Options$span,
		...
		},
		{
			ctor: '::',
			_0: function () {
				var _p2 = model.selectedNutritionTab;
				if (_p2 === 0) {
...
var _user$project$Views$foodListView = function (selectedFoods) {
	var _p3 = _elm_lang$core$List$isEmpty(selectedFoods);
	if (_p3 === true) {
		return _elm_lang$html$Html$text('Select Food');
	} else {
		return _user$project$Views_Food$selectedFoodList(selectedFoods);
	}
};
var _user$project$Views$homeView = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Views$nutritionView(model),
			_1: {
				ctor: '::',
				_0: _user$project$Views$foodListView(model.selectedFoods),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Views$viewBody = function (model) {
	var _p4 = model.route;
	switch (_p4.ctor) {
		case 'HomeRoute':
...
var _user$project$Views$drawerHeader = function (model) {
	return A3(
		_debois$elm_mdl$Material_Options$styled,
		_elm_lang$html$Html$header,
		{
			...
			_1: {
				...
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: A2(_debois$elm_mdl$Material_Options$css, 'height', '151px'),
							_1: {
								ctor: '::',
								_0: A2(_debois$elm_mdl$Material_Options$css, 'flex-direction', 'column'),
								_1: {
									ctor: '::',
									_0: _debois$elm_mdl$Material_Options$cs('demo-header'),
									_1: {
										ctor: '::',
										_0: _debois$elm_mdl$Material_Color$background(
		...
		},
		{
			...
			_0: A3(
				...
				_elm_lang$html$Html$img,
				{
					ctor: '::',
					_0: _debois$elm_mdl$Material_Options$attribute(
						_elm_lang$html$Html_Attributes$src('images/elm.png')),
					_1: {
						ctor: '::',
						_0: A2(_debois$elm_mdl$Material_Options$css, 'width', '48px'),
						_1: {
							ctor: '::',
							_0: A2(_debois$elm_mdl$Material_Options$css, 'height', '48px'),
							_1: {
								ctor: '::',
								_0: A2(_debois$elm_mdl$Material_Options$css, 'border-radius', '24px'),
								_1: {ctor: '[]'}
							}
						}
					}
				...
				_0: A3(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Come On!'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}),
...
var _user$project$Views$viewDrawerMenuItem = F2(
	function (model, _p5) {
		var _p6 = _p5;
		var _p8 = _p6._2;
		var isCurrentLocation = _elm_lang$core$Native_Utils.eq(model.route, _p8);
		var onClickCmd = function () {
			var _p7 = {ctor: '_Tuple2', _0: isCurrentLocation, _1: _p8};
			if ((_p7.ctor === '_Tuple2') && (_p7._0 === false)) {
				return _debois$elm_mdl$Material_Options$onClick(
					_user$project$Messages$NewUrl(
						A2(_user$project$Routing$urlFor, model.url.src_url, _p7._1)));
			} else {
				return _debois$elm_mdl$Material_Options$nop;
			}
		}();
				...
				_1: {
					...
					_0: A2(
						...
						_debois$elm_mdl$Material_Color$background(
							A2(_debois$elm_mdl$Material_Color$color, _debois$elm_mdl$Material_Color$BlueGrey, _debois$elm_mdl$Material_Color$S600))),
					_1: {
						ctor: '::',
						_0: A2(_debois$elm_mdl$Material_Options$css, 'color', 'rgba(255, 255, 255, 0.56)'),
						_1: {
							ctor: '::',
							_0: A2(_debois$elm_mdl$Material_Options$css, 'font-weight', '500'),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _user$project$Views$viewDrawer = function (model) {
	return A2(
		_debois$elm_mdl$Material_Layout$navigation,
		{
			ctor: '::',
			_0: _debois$elm_mdl$Material_Color$background(
				A2(_debois$elm_mdl$Material_Color$color, _debois$elm_mdl$Material_Color$BlueGrey, _debois$elm_mdl$Material_Color$S800)),
			_1: {
				ctor: '::',
				_0: _debois$elm_mdl$Material_Color$text(
					A2(_debois$elm_mdl$Material_Color$color, _debois$elm_mdl$Material_Color$BlueGrey, _debois$elm_mdl$Material_Color$S50)),
		...
		A2(
			_elm_lang$core$List$map,
			_user$project$Views$viewDrawerMenuItem(model),
...
var _user$project$Views$viewHeader = function (model) {
	...
	switch (_p9.ctor) {
		case 'HomeRoute':
			return _user$project$Helpers$defaultHeader('营养建议');
		case 'InfoCollectionRoute':
			return _user$project$Helpers$defaultHeader('请输入锻炼指标');
		case 'FoodRoute':
			return _user$project$Helpers$defaultHeader('营养元素(单位: 克／克)');
		case 'IntroRoute':
			return _user$project$Helpers$defaultHeader('三分练七分吃');
		default:
			return _user$project$Helpers$defaultHeader('找不到您要的网站');
	}
};
var _user$project$Views$view = function (model) {
	return _debois$elm_mdl$Material_Scheme$top(
		A4(
			...
			{
				ctor: '::',
				_0: _debois$elm_mdl$Material_Layout$selectedTab(model.selectedMenuTab),
				_1: {
					ctor: '::',
					_0: _debois$elm_mdl$Material_Layout$onSelectTab(_user$project$Messages$SelectMenuTab),
					_1: {
						ctor: '::',
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: A2(_debois$elm_mdl$Material_Options$css, 'display', 'flex !important'),
								_1: {
									ctor: '::',
									_0: A2(_debois$elm_mdl$Material_Options$css, 'flex-direction', 'row'),
									_1: {
			...
			{
				header: _user$project$Views$viewHeader(model),
				drawer: {
					ctor: '::',
					_0: _user$project$Views$drawerHeader(model),
					_1: {
						ctor: '::',
						_0: _user$project$Views$viewDrawer(model),
						_1: {ctor: '[]'}
					}
				},
				tabs: {
					ctor: '_Tuple2',
					_0: _user$project$Routing$tabsTitles(model.url.src_url),
					_1: {
						ctor: '::',
						_0: _debois$elm_mdl$Material_Color$background(
			...
			case 'HomeRoute':
				...
				if (_p4 === true) {
					...
					return _elm_lang$navigation$Navigation$newUrl(
						A2(_elm_lang$core$Basics_ops['++'], model.url.src_url, '/infocollection'));
				}
			case 'InfoCollectionRoute':
				return _elm_lang$core$Platform_Cmd$none;
			case 'FoodRoute':
		...
		switch (_p5.ctor) {
			...
			case 'WeightFatRate':
				...
				var newInputValues = _elm_lang$core$Native_Utils.update(
					inputValues,
					{
						weight_fat_rate: _elm_lang$core$Maybe$Just(
							A2(
								_elm_lang$core$Result$withDefault,
								_user$project$Config$invalidValue,
								_elm_lang$core$String$toFloat(_p5._0)))
			...
			case 'TrainingTime':
				...
				var newInputValues = _elm_lang$core$Native_Utils.update(
					inputValues,
					{
						training_time: _elm_lang$core$Maybe$Just(
							A2(
								_elm_lang$core$Result$withDefault,
								_user$project$Config$invalidValue,
								_elm_lang$core$String$toFloat(_p5._0)))
			...
			case 'SelectNutritionTab':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{selectedNutritionTab: _p5._0}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'SelectMenuTab':
				var _p6 = _p5._0;
			...
			case 'NewUrl':
				var toggleDrawerCmd = _user$project$Helpers$cmd(
					_debois$elm_mdl$Material_Layout$toggleDrawer(_user$project$Messages$Mdl));
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					model,
					{
			...
			case 'OnLocationChange':
				...
				var newRoute = A2(_user$project$Routing$parseLocation, _p7, model.url.src_url);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{route: newRoute, selectedMenuTab: newSelectedMenuTab}),
			...
			case 'TriggerCalc':
				...
				return {
					...
					_1: _elm_lang$navigation$Navigation$newUrl(model.url.src_url)
				};
			default:
				var newSelectedFoods = {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: _p5._0, _1: _p5._1},
					_1: model.selectedFoods
				};
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
...
var _user$project$Main$init = function (location) {
	...
	var url = {
		origin: location.origin,
		src_url: src_url,
		api_url: A2(_elm_lang$core$Basics_ops['++'], location.origin, '/api/v1/gymcalc')
	};
	var initCommand = A2(
